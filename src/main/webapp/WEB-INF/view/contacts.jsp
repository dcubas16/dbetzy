      ...
      <div class="row-nav"> 
        ...
        <nav>
          <ul class="sf-menu responsive-menu sf-js-enabled">
            ...
            <li class="last-item current"><a href="index-5.html">Contacts</a></li>
          </ul>
        </nav>
        <div class="clear"></div>
      </div>
            ...
            <div class="wrapper">
              <article class="grid_5">
                <div class="aligncenter">
                  <h2>find us</h2>
                  <div class="box-pattern b"><span></span><strong></strong><span></span></div>
                  <div class="p3">
              ...
              <article class="grid_7">
                ...
                <form id="contact-form">
                  ...
                  <fieldset>
                    ...
                    <div class="buttons-wrapper"> <a class="button" data-type="reset">Clear</a> <a class="button" data-type="submit">send message</a></div>
                  </fieldset>
                </form>
              </article>
            </div>
