      ...
      <div class="row-nav"> 
        ...
        <nav>
          <ul class="sf-menu responsive-menu sf-js-enabled">
            ...
            <li class="current"><a href="index-3.html">Style</a></li>
          ...
          <div class="container_12">
            <div class="wrapper">
              ...
              <article class="grid_3 p3">
                <div class="aligncenter">
                  <figure class=""><a class="fancybox-button box-img" data-fancybox-group="gallery" href="images/image-blank.png" title=""><img src="images/page4-img1.jpg " alt=""><span></span></a></figure>
                </div>
              </article>
              <article class="grid_3 p3">
                <div class="aligncenter">
