	...
	<div class="bg-main">
		...
		<header>
			<div align="right" style="padding: 6px">
				<a href="?locale=en_US"><img alt="" src="../dbetzy/resources/images/bandera_usa.gif"></a>
				<a href="?locale=en_US"><spring:message code="label.english"/></a>|
				<a href="?locale=es_PE"><img alt="" src="../dbetzy/resources/images/bandera_esp.gif"></a>
				<a href="?locale=es_PE"><spring:message code="label.spanish"/></a>
			</div>
			<div class="main-1">
				<div class="row-top">
					<!--======================== logo ============================-->
